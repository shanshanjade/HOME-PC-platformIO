...
void drawWeek(uint8_t _week)
{
	...
	{
	case 0:
		matrix.drawPixel(1, 7, 0xf800);
		matrix.drawPixel(2, 7, 0xf800);
		matrix.drawPixel(3, 7, 0xf800);
		break;
	case 1:
		matrix.drawPixel(5, 7, 0xf800);
		matrix.drawPixel(6, 7, 0xf800);
		matrix.drawPixel(7, 7, 0xf800);
		break;
	case 2:
		matrix.drawPixel(9, 7, 0xf800);
		matrix.drawPixel(10, 7, 0xf800);
		matrix.drawPixel(11, 7, 0xf800);
		break;
	case 3:
		matrix.drawPixel(13, 7, 0xf800);
		matrix.drawPixel(14, 7, 0xf800);
		matrix.drawPixel(15, 7, 0xf800);
		break;
	case 4:
		matrix.drawPixel(17, 7, 0xf800);
		matrix.drawPixel(18, 7, 0xf800);
		matrix.drawPixel(19, 7, 0xf800);
		break;
	case 5:
		matrix.drawPixel(22, 7, 0xf800);
		matrix.drawPixel(23, 7, 0xf800);
		matrix.drawPixel(24, 7, 0xf800);
		matrix.drawPixel(25, 7, 0xf800);
		break;
	case 6:
		matrix.drawPixel(27, 7, 0xf800);
		matrix.drawPixel(28, 7, 0xf800);
		matrix.drawPixel(29, 7, 0xf800);
		matrix.drawPixel(30, 7, 0xf800);
		break;
	}
}
//-------------------显示文字及滚动--------------------------------
...
String ipaddr;
//------------------显示菜单及滚动---------------------------------
void showMenu(char *message, uint16_t color)
{
	flag = -1;
	cursorX = 0;
	oneSecond = 0;
	...
	if (Serial.available() > 0)
	{
		...
		if (loopTicker.active())
		{
			...
			case 2:
				...
				showMenu(myMenu[funcIndex].menuString, colors[systemColorIndex]);
